const uz = {
  ...
  soon: "Tez kunda <span class='menu-soon-arrow'></span>",
  heroTitle: "Sug’urta bo’yicha <span style='color: black;'>yagona sotuv bilan cheklanmagan</span> marketplace</span",
  heroDesc: "“Biz sug’urta sotuvi bilan cheklanmaymiz”",
  heroBtn: "Kirish",
  aboutTitle: "Biz haqimizda",
  aboutSubtitle: "Innovatsion <span style='color: black'>Sug'urta Yechimlari</span>",
  ...
  trustWhy: "Nega bizga <span style='color: black'>ishonishingiz mumkin?</span>",
  ...
  osagosugTableTitle: "Sug'urtalarim",
  osagophoneFormLabel: "Davom etish uchun telefon raqamingizni kiriting",
  osagophoneCallTitle: "Qo‘ng‘iroq qiling:",
  logout: "Tizimdan chiqish <img style='margin-left:13px' class='exit-logo' src='/assets/images/exit.svg' alt='Tasdiqlash'>",
  ...
  enterCode: "Kodini kiriting",
  enterPhoneToContinue: "Davom etish uchun telefon raqamingizni kiriting",
  call: "Qo‘ng‘iroq qiling:",
  confirm: "Tasdiqlash",
  second: "Sekund",
  tableId: "ID",
  tableName: "Ism Familiya",
  tableInsurance: "Sug'urta",
  tableStart: "Boshlanishi",
  tableEnd: "Tugash",
  tableDownload: "Yuklash",
  tableFio: "F.I.O.",
  tablePhone: "Telefon raqam",
  tablePayment: "To'lov",
  tableDrivers: "Qo'shilgan haydovchilar",
